...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Waitlisted.ReservationsResponse();
  });
  ...
  describe('ReservationsResponse', function() {
    it('should create an instance of ReservationsResponse', function() {
      ...
      //var instane = new Waitlisted.ReservationsResponse();
      //expect(instance).to.be.a(Waitlisted.ReservationsResponse);
    });
    ...
    it('should have the property referredCount (base name: "referred_count")', function() {
      // uncomment below and update the code to test the property referredCount
      //var instane = new Waitlisted.ReservationsResponse();
      //expect(instance).to.be();
    });
